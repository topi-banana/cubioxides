//! 1.18+ `gen_biomes` parity at scale=1 (voronoi access) vs cubiomes'
//! `genBiomeNoiseScaled`. Tests both the single-cell direct sample
//! path and the multi-cell pre-computed source-range path.
...
#[test]
fn voronoi_biomes_matches_cubiomes() {
    ...
    for i in 0..count as usize {
        ...
        assert_eq!(
            got, expected,
            "case {i} (seed={seed:#x}, area=({rx},{ry},{rz})+({sx},{sy},{sz}))",
        );
    }
}
